...
The number of such functional subtypes is growing as new methods identify increasingly specific functional and genetic programs that define RGC subtypes (e.g., \citenoparens{rivlin2011transgenic,baden2016functional}).
...
Briefly, \citetext{godement1984prenatal} concluded that ipsilateral RGC axons localize to the superficial optic tract, while contralateral RGC axons occupy the entire tract.
...
However, motor axons projecting to different parts of fast muscle fibers remain intermingled en route to the muscle, suggesting that a second step of axon sorting occurs within the target to organize this subset of inputs \cite{milner1998selective}.
