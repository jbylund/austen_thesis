...
Additionally, several early \invitro{} experiments demonstrated that axons need a substrate on which to extend \cite{hammarback1988growth}, and that guidance decisions are made at the growth cone, which interpret attractive and repulsive signals \cite{raper1990temporal,fan1995localized}.
...
Indeed, axons prefer to grow along other axons both \invivo{} \cite{raper1983pathfinding,tosney1985development} and \invitro{} \cite{bonhoeffer1985position}.
...
Curiously, TCAs and CTAs collapse upon contact with each other \invitro{}, and thus are not intrinsically inclined to co-fasciculate \cite{bagnard2001axonal}.
