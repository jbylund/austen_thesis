...
\begin{figure}[hbtp]
    \begin{center}
        \includegraphics[width=\textwidth]{Figures/DiIDiD_WholeTract.pdf}
...
\begin{figure}[hbtp]
    \begin{center}
        \includegraphics[width=\textwidth]{Figures/HighRes_IpsiContra.pdf}
...
At P0 and P2, most if not all of the late-born VT contra and VT ipsi axons have entered the optic tract.
...
\begin{figure}[hbtp]
    \begin{center}
        \includegraphics[width=\textwidth]{Figures/DiIDiD_WT_VTVT.pdf}
        ...
        %After transport of the lipophilic dye tracers, horizontal sections were taken through the tract.
        ...
        Sections shown are representative of six samples. %Verify 
		Ipsi RGC axons are labeled with DiD (pseudocolored green) and contra RGC axons are labeled with DiI (pseudocolored magenta).
