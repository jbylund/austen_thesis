...
\begin{figure}[hbtp]
    \begin{center}
        ...
        Samples shown are representative of 6 or more pups from 3 or more litters, per labeling scheme. %check numbers
...
\begin{figure}[hbtp]
    \begin{center}
		...
		Representative images are shown from 3 or more samples from 2 or more litters for each labeling scheme
