...
Current advances in both tissue clearing techniques (reviewed in \citenoparens{tainaka2015chemical}) and high-resolution microscopy for large intact samples, like light-sheet microscopy \cite{keller2015visualizing}, will soon afford more complete views of axons in this region than have previously been possible to acquire.
...
The position of ipsi axons in the lateral optic tract, identified here either via SERT-Cre:zsgreen expression or with DiI and DiD, corresponds with the early report by Godement et al. \shortcite{godement1984prenatal}.
...
Of course, segregation of ipsi and contra axons is not complete --- i.e., there are not two distinct bundles in the tract, one of only ipsi axons and one of only contra axons.
