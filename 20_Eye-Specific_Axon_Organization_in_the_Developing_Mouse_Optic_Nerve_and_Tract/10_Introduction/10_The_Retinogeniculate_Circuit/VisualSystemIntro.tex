...
\begin{figure}[hbtp]
	\begin{center}
		...
		The cortex is shown with dashed lines for context. 
		The schematic is shown in a frontal view.}
...
\begin{figure}[hbtp]
	\begin{center}
		...
		In the early phase of RGC axon outgrowth, at left, both ipsi and contra RGCs arise in the central retina.
		RGC differentiation continues in a center-to-periphery wave.
		During the peak phase of axon outgrowth, ventrotemporal (VT) retina produces predominantly ipsi RGCs, with contras arising everywhere else.
