...
%
%A second technical issue occured during the fixation step, and may be related to the efficacy of laminin transfer and ensuing limitations on explant and neurite adhesion to the coverslip.
...
%Using a fixative mix suggested by Dr. Fiederling has ameliorated this problem.
%Compared with 4\% PFA, a cocktail of PFA and glutaraldehyde in a 10\% sucrose solution helps reduce the stress on neurite-substrate adhesion during the fixation step and maintains the integrity of the cultured neurites.
%This is likely because the fixative sucrose solution better matches the viscosity of the growth media, keeping the structure of the culture more intact.
%
