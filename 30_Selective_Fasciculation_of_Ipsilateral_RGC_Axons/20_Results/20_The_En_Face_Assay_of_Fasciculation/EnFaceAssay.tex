...
\begin{figure}[hbtp]
    \begin{center}
        ...
        *=p<0.05, 1-tailed t-test.
        C) Inter-explant fasciculation events, measured by ABI, are short (note difference in Y axis in B and C) in all conditions, with no statistical differences between DT/DT, VT/VT, and DT/VT pairs.
