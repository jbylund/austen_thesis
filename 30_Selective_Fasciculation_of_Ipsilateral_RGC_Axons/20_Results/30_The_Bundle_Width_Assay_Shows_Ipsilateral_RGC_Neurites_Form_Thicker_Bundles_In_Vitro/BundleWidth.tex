...
The first attempt at measuring neurite bundle widths used automated measurements in Fiji (a distribution of the open-source ImageJ software, \citenoparens{schindelin2012fiji}).
...
Given the shortcomings of the automated approaches available, I turned instead to manually measuring neurite bundle widths.
