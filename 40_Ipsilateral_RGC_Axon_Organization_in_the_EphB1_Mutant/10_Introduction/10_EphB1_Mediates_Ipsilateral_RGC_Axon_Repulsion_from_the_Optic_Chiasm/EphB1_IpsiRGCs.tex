One particular member of the RTK family of Eph receptors, EphB1, plays a significant role in formation of the binocular visual circuit prior to formation of the retinotopic map in the thalamic targets \cite{petros2008retinal,williams2003ephrin,lee2008zic2}.
...
Concurrently, EphB1 is expressed exclusively in the VT retina at the time when VT retina is producing ipsi RGCs \cite{williams2003ephrin}, and is downstream of the ipsi-specific transcription factor Zic2 (\citenoparens{lee2008zic2,garcia2008zic2}, see Figure~\ref{SertRetina}A).
