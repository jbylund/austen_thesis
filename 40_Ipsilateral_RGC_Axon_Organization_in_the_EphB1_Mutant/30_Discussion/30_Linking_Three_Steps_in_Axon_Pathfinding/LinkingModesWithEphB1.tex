...
Future studies in the EphB1\textsuperscript{-/-} can address several questions that will further our understanding of how different steps of axon guidance are related to each other.
...
Thus, further analysis of the EphB1\textsuperscript{-/-} mutant, as well as more detailed molecular dissection in the wild-type optic tract, will help the field start to connect various steps along an axon's journey that have largely been studied as discrete events.