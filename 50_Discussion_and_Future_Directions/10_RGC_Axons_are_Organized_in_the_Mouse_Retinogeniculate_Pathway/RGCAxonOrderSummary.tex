...
Chronotopic organization has been described in the visual system (e.g., \citenoparens{colello1998changing,colello1992observations,reese1987distributionrat}), largely tracing growth cone disposition in electron microscopy (EM) images.
...
However, especially as our ability to identify and label RGC subtypes improves (e.g., \citenoparens{baden2016functional,rivlin2011transgenic}), it will particularly fascinating to explore the organization of functional subtype specific RGC axons in the optic nerve and tract.
