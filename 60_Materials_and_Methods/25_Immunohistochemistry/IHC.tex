...
Primary antibodies were applied in a 1X PBS + 1\% Triton X-100 + 5\% NGS solution and incubated O/N at \textcelsius{4}.
...
\textbf{Immunostaining of zsgreen in vibratrome sections with DiD label} \newline
...
Primary antibodies were applied in a 1X PBS + 0.25\% Tween 20 + 5\% NGS solution and incubated for 2 nights at \textcelsius{4}.
...
Slides with cryosections were brought to RT from \textcelsius{-80} and left to dry before being rinsed with 1X PBS once for 5-10 min.
Samples were incubated for 45-90 min at RT with blocking solution composed of 1X PBS + 0.5\% Tween + 10\% NGS.
Primary antibodies were applied in a 1X PBS + 0.5\% Tween 20 + 10\% NGS solution and incubated for 2 nights at \textcelsius{4}.
