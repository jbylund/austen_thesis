...
\begin{figure}[hbtp]
    \begin{center}
		...
		Moreover, BABB-treated tissue shrunk considerably: the surface area of the section after BABB treatment, normalized to pre-cleared sections, was 0.50\pm0.02 (mean \pm s.e.m.), n=4 sections; P<0.01, Student’s t-test.
		Scale bars: 100$\mu$m.
		}
        \label{ClearT_SFig2}
    \end{center}
...
We then examined DiI-labeled RGC axons in cleared tissue at the optic chiasm at E15.5 (Figure~\ref{ClearT_Fig2}A).
...
CTB labeling was preserved after \emph{Clear\textsuperscript{T}} and BABB treatments, but BABB reduced tissue size by half (before clearing=1\pm0 versus cleared=0.50\pm0.02, P<0.05, n=4 sections), while labeling was diffuse following Sca\emph{l}eA2 treatment (Figure~\ref{ClearT_SFig2}B).
