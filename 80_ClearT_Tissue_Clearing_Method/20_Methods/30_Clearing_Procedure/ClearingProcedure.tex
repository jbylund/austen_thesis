Incubation times in each solution vary according to tissue thickness for the desired transparency (see Tables ~\ref{table:cleartresults} and ~\ref{table:cleart2results} for details).
